...
struct StoryBrain {
    let storyArray = [/*Story(title: "You see a fork in the road.", choice1: "Take a left.", choice1Destination: 1, choice2: "Take a right.", choice2Destination: 2),
    ...
    var storyNumber = 0
    // методы возвращающие значение для использования их в ViewController для функции UpdateUI
